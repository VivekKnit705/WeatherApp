...
const API_KEY = '6e53d4d6ea398500db3b226bfc9786fa';
...
function getWeatherData() {
    navigator.geolocation.getCurrentPosition((success) => {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&exclude=houarly,minutely&units=metric&appid=${API_KEY}`)
...
function showWeatherData(data) {
  ...
  <div>${window.moment(sunset * 1000).format('HH: mm a')}</div>
    ...
    weatherForecastEl.innerHTML = othersDayForecast;
}
